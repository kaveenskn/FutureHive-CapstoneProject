          ...
          {showSignUp ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="w-full">
                ...
                <button
                  type="submit"
                  className="hover:bg-blue-600 w-full px-8 py-2 mb-6 text-white transition bg-blue-500 rounded-full"
                >
                  SIGN UP
                </button>
              </form>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="w-full">
                ...
                <a
                  href="#"
                  className="hover:underline self-start mb-10 text-sm text-blue-500"
                >
